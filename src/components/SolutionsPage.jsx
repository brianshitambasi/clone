        ...
        <Container>
          <Row>
            <Col lg={8} className="mx-auto text-center">
              <Badge bg="light" text="dark" style={{ marginBottom: '20px', padding: '8px 16px', borderRadius: '50px' }}>
                <FaStar style={{ marginRight: '5px', color: '#ffc107' }} /> Enterprise-Grade Solutions
              </Badge>
              <h1 style={{ fontSize: '3.5rem', fontWeight: '800', marginBottom: '20px', color: '#ffffff' }}>
                360-Degree Solutions
              </h1>
              <p style={{ fontSize: '1.2rem', maxWidth: '800px', margin: '0 auto', opacity: 0.95, color: 'rgba(255,255,255,0.95)' }}>
          ...
          {solutions.map((solution, index) => (
            <Col md={6} lg={4} key={index} className="mb-4">
              ...
              onMouseLeave={(e) => {
                ...
                <h3 style={{ marginBottom: '5px', fontSize: '1.5rem', color: '#ffffff' }}>{solution.title}</h3>
                <p style={{ color: solution.color, marginBottom: '15px', fontSize: '0.85rem' }}>{solution.platform}</p>
                <p style={{ color: '#aaa', marginBottom: '20px', lineHeight: '1.6' }}>{solution.desc}</p>
                <div style={{ marginBottom: '25px' }}>
                  {solution.benefits.map((benefit, idx) => (
                    <div key={idx} style={{ fontSize: '0.85rem', color: '#ccc', marginBottom: '8px' }}>
                      <FaCheckCircle style={{ color: solution.color, marginRight: '8px', fontSize: '0.7rem' }} /> {benefit}
                    </div>
                  ))}
                </div>
                <Button 
        ...
        <Row style={{ marginTop: '60px' }}>
          <Col className="text-center">
            <Card style={{ backgroundColor: '#1a1a1a', border: 'none', borderRadius: '20px', padding: '50px' }}>
              <h3 style={{ marginBottom: '20px', color: '#ffffff' }}>Ready to Transform Your Business?</h3>
