...
const CaseStudiesPage = () => {
  const caseStudies = [
    { id: 'zero-copy', icon: <FaShoppingCart />, title: 'Zero-Copy Revolution', subtitle: 'Retail Data Federation', desc: 'Implemented zero-copy data integration for a major retailer, reducing data duplication by 95% and accelerating analytics by 10x.', results: ['95% reduction in data duplication', '10x faster analytics', '$2M annual savings'] },
    { id: 'project-titan', icon: <FaServer />, title: 'Project Titan', subtitle: '2,000-Server Migration', desc: 'Executed a zero-downtime migration of 2,000 servers to AWS, transforming legacy infrastructure into a modern cloud architecture.', results: ['Zero downtime migration', '40% cost reduction', '99.99% availability achieved'] },
    { id: 'mission-impact', icon: <FaCloud />, title: 'Mission Impact', subtitle: 'Salesforce Nonprofit Cloud', desc: 'Scaled global nonprofit operations across 50 countries using Salesforce Nonprofit Cloud and AI-driven donor insights.', results: ['300% increase in donor engagement', '50-country rollout', 'Real-time impact reporting'] }
  ];
            ...
            <Row className="g-0">
              ...
              <Col md={8}>
                <Card.Body style={{ padding: '40px' }}>
                  ...
                  <Button as={Link} to={`/case-studies/${study.id}`} variant="outline-primary" style={{ borderRadius: '50px' }}>Read Full Case Study →</Button>
                </Card.Body>
              </Col>
            </Row>
          </Card>
